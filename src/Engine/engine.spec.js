...
describe('Recta testing', () => {
	...
	test('calcVals with recta input', function() {
		  const input = [
			{x: 1, y: 5},
			{x: 2, y: 6},
			{x: 3, y: 9},
	...
	test('calcVals with recta input. Checking types', function() {
		  const input = [
			{x: 1.12312321, y: 5},
			{x: 13, y: -6.123},
			{x: 3, y: 9.000001},
	...
	test('solveEquation recta input', function() {
		const vals = [ 
			[ 
	...
	test('solveEquation with recta input. Checking types', function() {
		const vals = [ 
			[ 
	...
	test('errors calc with recta params', function() {
		const input = [
			{x: 1, y: 5},
			{x: 2, y: 6},
			{x: 3, y: 9},
	...
	test('errors calc with recta params. Cheking types', function() {
		const input = [
			{x: 1, y: 5.32},
			{x: 2, y: 6},
			{x: 3, y: -1.29},
...
describe('Parabola testing', () => {
	...
	test('calcVals with parabola input', function() {
		const input = [
			{x: 1, y: 5},
			{x: 2, y: 6},
			{x: 3, y: 9},
